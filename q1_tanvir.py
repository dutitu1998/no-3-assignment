...
#sol1_ivp = solve_ivp(t * np.exp(3*t) - 2*y, [0, 1], [0], t_eval=t1)
sol1_ivp = solve_ivp(ode1, [0, 1], [0], t_eval=t1)
y1_ivp = sol1_ivp.y.T #soution gives(1,50) where 1 is row and total 50 column but we want 50 row 1 column
